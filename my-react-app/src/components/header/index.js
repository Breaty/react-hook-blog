...
function HeaderViewer(props){
    ...
    const menus = [{title:"home",path:"/",icon:<AppstoreOutlined/>}
    ...
    return (
        <div className="header-container clearfix">
            ...
            {/* 未登录 */}
            {!props.state.loginReducer.loginState && <SubMenu key="SubMenu" className="menu-subs" icon={<UserOutlined />}>
            ...
            {/* 已经登录 */}
            {props.state.loginReducer.loginState && <SubMenu  icon={<UserOutlined />} title={props.state.loginReducer.username}>
